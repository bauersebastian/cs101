...
is_palindrome = wordbackwards.find(word)
...
position2 = len(marker)
position3 = len(replacement)
position4 = position3 - position2
position5 = position + position3

replaced = line[:position] + replacement + line[position5 - position4:]

print replaced

line_marker = line.find(marker)
replaces = line[:line_marker] + replacement + line[line_marker + len(marker):]
print replaces
